...
function createModal(data) {
  ...
  newModal.innerHTML = `<div class="modal-content">
    ...
    <div class="modal-contact">
      <p>${data.cell}</p>
      <p class="city">${data.location.street.number} ${data.location.street.name}, ${data.location.city}, ${data.location.state}, ${data.location.postcode}</p>
...
search.addEventListener('keyup', () => {
  ...
  let nameItems = document.querySelectorAll('h2.name');
